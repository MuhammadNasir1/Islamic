...
@section('content')
    <div class="w-full pt-10 min-h-[88vh] border-2 shadow-2xl rounded-xl">
        <div class="flex justify-between w-full px-5">
            <div>
                <h1 class="text-3xl font-bold">Hadith</h1>
            </div>
            <div>
        ...
        <div id="categoryTable" class="transition-opacity duration-500 ">
            @php
                $headers = ['Sr.', 'Hadith (English)', 'Hadith (Arabic)', 'Category', 'Book.......', 'Hadith No.', 'Action'];
            @endphp
                        ...
                        <div class="grid gap-4 ">
                            <div class="w-full ">
                                ...
                                <div class="grid grid-cols-3 gap-2 mt-4">
                                    ...
                                    <x-select name="category_type" id="categoryType1" label="Select Book">
                                        <x-slot name="options">
                                            <option disabled selected>Select </option>
                                            <option value="blogs">Blog</option>
                                            <option value="diseases">Diseases</option>
