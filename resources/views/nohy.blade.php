...
@section('content')
    <div class="w-full pt-10 min-h-[88vh] border-2 shadow-2xl rounded-xl">
        <div class="flex justify-between w-full px-5">
            <div>
                <h1 class="text-3xl font-bold">Nohy</h1>
            </div>
            <div>
        ...
        <div id="categoryTable" class="transition-opacity duration-500 ">
            @php
                $headers = ['Sr.', 'Noha Title', 'Reciter Name', 'Category (English)', 'Audio File', 'Action'];
            @endphp
                ...
                <form id="postDataForm" url="../saveCategory" enctype="multipart/form-data" method="post">
                    ...
                    <div class="">
                        <div class="grid gap-4 ">
                            <div class="w-full ">
                                <x-input class="" id="categoryName" label="Noha Title" placeholder="Enter Here"
...
@section('js')
    <script>
        ...
        $('#addModalBtn').click(function() {
            ...
            $('#categories-modal #modalTitle').text("Add Noha");
            $('#categories-modal #btnText').text("Add Noha");
