...
@section('content')
    <div class="w-full pt-10 min-h-[88vh] border-2 shadow-2xl rounded-xl">
        <div class="flex justify-between w-full px-5">
            <div>
                <h1 class="text-3xl font-bold">Ayah</h1>
            </div>
            <div>
        ...
        <div id="categoryTable" class="transition-opacity duration-500 ">
            @php
                $headers = ['Sr.', 'Ayah (English)', 'Ayah (Arabic)', 'Category',  'Action'];
            @endphp
            <x-table :headers="$headers">
                <x-slot name="tablebody">
                    <tr>
                        <td>1</td>
                        <td>Verily, actions are by intentions,
                            and for every person is what he
                            intended...</td>
                        <td>إِنَّمَا الْأَعْمَالُ بِالنِّيَّاتِ، وَإِنَّمَا لِكُلِّ امْرِئٍ مَا نَوَى، فَمَنْ۔۔۔</td>
                        <td>Category 1</td>
                        <td>
                            <div class='flex gap-4'>
                                ...
                                <button mediaTitle="" mediaAuthor="" mediaCategory="" mediaCategoryId="" mediaDate=""
                                    ...
                                    mediaImage="{{ asset('assets/default-logo-req.png') }}" class="viewModalBtn">
                        ...
                        <div class="ml-5">
                            ...
                            <div class="mt-5 md:grid-cols-3">
                                <div class="min-w-10 md:col-span-2 ">
                                    <p class=" text-[#323C47] text-[12.9px] lg:text-lg md:text-lg" id="">عَنْ
                                        أَبِي هُرَيْرَةَ رَضِيَ اللهُ عَنْهُ أَنَّ رَسُولَ اللهِ صَلَّى اللهُ عَلَيْهِ
                                        وَسَلَّمَ قَالَ: "إِنَّمَا الْأَعْمَالُ بِالنِّيَّاتِ، وَإِنَّمَا لِكُلِّ امْرِئٍ
                                        مَا نَوَى، فَمَنْ كَانَتْ هِجْرَتُهُ إِلَى اللَّهِ وَرَسُولِهِ فَهِجْرَتُهُ إِلَى
                                        اللَّهِ وَرَسُولِهِ، وَمَنْ كَانَتْ هِجْرَتُهُ لِدُنْيَا يُصِيبُهَا أَوِ امْرَأَةٍ
                                        يَنْكِحُهَا فَهِجْرَتُهُ إِلَى مَا هَاجَرَ إِلَيْهِ.</p>
                                    <p class="mt-4 text-[#323C47] text-[12.9px] lg:text-lg md:text-lg" id="">Abu
                                        Hurairah narrated that: Verily, actions are by intentions, and for every person is
                                        what he intended. So whoever emigrated for Allah and His Messenger, his emigration
                                        is for Allah and His Messenger. And whoever emigrated for worldly gain or to marry a
                                        woman, his emigration is for that which he emigrated.</p>
                                    <p class="mt-4 text-[#323C47] text-[12.9px] lg:text-lg md:text-lg" id="">
                                        Category (ا ب ج )</p>
                                </div>
                            </div>
                        </div>
...
@section('js')
    <script>
        ...
        $('#addModalBtn').click(function() {
            ...
            $('#categories-modal #modalTitle').text("Add Ayah");
            $('#categories-modal #btnText').text("Add Ayah");
