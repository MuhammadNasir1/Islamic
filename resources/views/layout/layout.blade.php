...
<body>
    <div class="flex  bg-[#029000] h-[100vh]  scroll-smooth">
        <div class="bg-[#029000] lg:w-[15rem]">
            <div class=" h-[100%] lg:overflow-hidden overflow-scroll  hidden p-2 lg:flex flex-col justify-between">
                <div>
                    ...
                    <ul class="pt-7">
                        <li class="">
                            <a href="/"
                                class="flex items-center justify-between px-1 py-3 text-white duration-500 rounded-lg hover:bg-white hover:fill-black hover:text-[#029000]">
                                <div class="flex gap-3">
                                    <svg class="w-6 h-6 ms-2  group-hover:stroke-[#029000]" width="25"
                        ...
                        {{-- <li>
                            <a href="#"
                                class="flex items-center justify-between px-1 py-3 text-white duration-500 rounded-lg hover:bg-white hover:fill-black hover:text-[#029000]">
                                <div class="flex gap-3">
                                    <svg class="group-hover:stroke-[#029000] ms-2" width="25" height="25"
                        ...
                        <div id="dropdown"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                <li>
                                    <a href="tasbih"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-[#029000]">Tasbih</a>
                                </li>
                                <li>
                                    <a href="hadith"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-[#029000]">Hadith</a>
                                </li>
                                <li>
                                    <a href="doa"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-[#029000]">Doa</a>
                                </li>
                                <li>
                                    <a href="ayah"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-[#029000]">Ayah</a>
                                </li>
                                <li>
                                    <a href="naat"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-[#029000]">Naat</a>
                                </li>
                                <li>
                                    <a href="nohy"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-[#029000]">Noha</a>
                                </li>
                                <li>
                                    <a href="post"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-[#029000]">Post</a>
                                </li>
                            </ul>
                        </div>
                        <li>
                            <a href="suggestion"
                                class="flex items-center justify-between px-1 py-3 text-white duration-500 rounded-lg fill-white hover:bg-white hover:fill-black hover:text-[#029000]">
                                <div class="flex gap-3">
                                    <svg class="group-hover:stroke-[#029000] ms-2" width="20" height="21"
                        ...
                        <li>
                            <a href="queries"
                                class="flex items-center justify-between px-1 py-3 text-white duration-500 rounded-lg fill-white hover:bg-white hover:fill-black hover:text-[#029000]">
                                <div class="flex gap-3">
                                    <svg class="group-hover:stroke-[#029000] ms-2" width="20" height="19"
                        ...
                        <li>
                            <a href="notification"
                                class="flex items-center justify-between py-2 text-white duration-500 rounded-lg fill-white hover:bg-white hover:fill-black hover:text-[#029000]">
                                <div class="flex gap-3">
                                    <svg class="group-hover:stroke-[#029000] ms-2" width="24" height="25"
                        ...
                        <li>
                            <a href="setting"
                                class="flex items-center justify-between px-1 py-3 text-white duration-500 rounded-lg fill-white hover:bg-white hover:fill-black hover:text-[#029000]">
                                <div class="flex gap-3">
                                    <svg class="group-hover:stroke-[#029000] ms-2" width="19" height="20"
                ...
                <div>
                    <ul class="mb-2">
                        <li>
                            <a href="loginpage"
                                class="flex items-center gap-3  px-1 py-3  text-white duration-500 rounded-lg fill-current hover:bg-white hover:fill-black hover:text-[#029000]">
            ...
            <div class="header flex justify-between h-[4rem] items-end">
                <div class="flex items-end">
                    ...
                    <div id="drawer-navigation"
                        class="fixed top-0 left-0 z-40 w-64 h-screen overflow-y-auto transition-transform -translate-x-full bg-[#029000] "
                        ...
                        <div>
                            ...
                            <ul class="pt-7">
                                <li class="">
                                    <a href="#"
                                        class="flex items-center justify-between mx-3 py-3 text-white duration-500 rounded-lg hover:bg-white hover:fill-black hover:text-[#029000]">
                                        <div class="flex gap-3">
                                            <svg class="w-6 h-6 ms-2  group-hover:stroke-[#029000]" width="25"
                                                height="25" viewBox="0 0 20 20" fill="currentcolor"
                                                xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li id="dropdownDefaultButton" data-dropdown-toggle="dropdowns">
                                    <a href="#"
                                        class="flex items-center justify-between mx-3 py-3 text-white duration-500 rounded-lg  hover:bg-white hover:fill-black hover:text-[#029000]">
                                        <div class="flex gap-3">
                                            <svg class="group-hover:stroke-[#029000] ms-2" width="25"
                                ...
                                <li>
                                    <a href="suggestion"
                                        class="flex items-center justify-between mx-3 py-3 text-white duration-500 rounded-lg fill-white hover:bg-white hover:fill-black hover:text-[#029000]">
                                        <div class="flex gap-3">
                                            <svg class="group-hover:stroke-[#029000] ms-2" width="20"
                                ...
                                <li>
                                    <a href="#"
                                        class="flex items-center justify-between mx-3 py-2  text-white duration-500 rounded-lg fill-white hover:bg-white hover:fill-black hover:text-[#029000]">
                                        <div class="flex gap-3">
                                            <svg class="group-hover:stroke-[#029000] ms-1" width="24"
                                ...
                                <li>
                                    <a href="setting"
                                        class="flex items-center justify-between mx-3 py-3 text-white duration-500 rounded-lg fill-white hover:bg-white hover:fill-black hover:text-[#029000]">
                                        <div class="flex gap-3">
                                            <svg class="group-hover:stroke-[#029000] ms-2" width="19"
                        ...
                        <div>
                            <ul class="mb-2">
                                <li>
                                    <a href="#"
                                        class="flex items-center gap-3 mx-3 py-3  text-white duration-500 rounded-lg fill-current hover:bg-white hover:fill-black hover:text-[#029000]">
                                        <span> <svg class="ms-2" width="20" height="19" viewBox="0 0 20 19"
                                                fill="currentcolor" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M4.54545 8.18182H11.8182V10H4.54545V12.7273L0 9.09091L4.54545 5.45455V8.18182ZM3.63636 14.5455H6.09818C7.1479 15.4712 8.44244 16.0744 9.82648 16.2827C11.2105 16.4909 12.6252 16.2954 13.9009 15.7195C15.1766 15.1437 16.259 14.212 17.0182 13.0362C17.7775 11.8604 18.1814 10.4905 18.1814 9.09091C18.1814 7.69129 17.7775 6.3214 17.0182 5.14563C16.259 3.96985 15.1766 3.03813 13.9009 2.46227C12.6252 1.88642 11.2105 1.69089 9.82648 1.89915C8.44244 2.10741 7.1479 2.71061 6.09818 3.63637H3.63636C4.48242 2.50653 5.5803 1.58956 6.84279 0.958313C8.10528 0.327069 9.49759 -0.00105786 10.9091 2.56208e-06C15.93 2.56208e-06 20 4.07 20 9.09091C20 14.1118 15.93 18.1818 10.9091 18.1818C9.49759 18.1829 8.10528 17.8548 6.84279 17.2235C5.5803 16.5923 4.48242 15.6753 3.63636 14.5455Z"
